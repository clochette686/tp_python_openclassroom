...
def attendre_son_tour(thread_recep_serveur, thread_envoi_serveur, partie_terminee):
    mon_tour = False
...
def deroulement_tours_de_jeu(thread_recep_serveur, thread_envoi_serveur):
    ...
    while not partie_terminee:
        ...
        (mon_tour, partie_terminee) = attendre_son_tour(thread_recep_serveur, thread_envoi_serveur, partie_terminee)
